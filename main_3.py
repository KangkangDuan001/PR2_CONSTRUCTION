...
def main():
    ...
    for j in range(num_updates):
        ...
        if (j % args.save_interval == 0
            ...
            torch.save(
                actor_critic_l,
            os.path.join(save_path, args.env_name + "_" + str(j) + "_" + str(total_episodes_rewards_l/num_episode_l) + "l_12.pt"))

            torch.save(
                actor_critic_r,
            os.path.join(save_path, args.env_name + "_" + str(j) + "_" + str(total_episodes_rewards_r/num_episode_r) + "r_12.pt"))
